...
const PsychologistDashboard = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex gap-6 text-lg bg-gray-200 px-6 py-3 rounded-lg shadow-md mb-6"
      ...
      >
        <input
          ...
          className="px-4 py-2 rounded-md border border-gray-300 shadow-sm text-xl focus:ring-2 focus:ring-blue-500"
        />
        <select
          value={month}
      ...
      {loading ? (
        ...
        <motion.p className="text-2xl mt-8 text-gray-500">
          {studentId
            ? "No survey data found for this student. Please select another period or student."
            : "Please enter a Student ID to view survey results."}
        </motion.p>
      )}
    </motion.div>
  );
